...
This repository aims at replicating [modded-nangpt](https://github.com/KellerJordan/modded-nanogpt) training with Jax instead of Pytorch. I would call it a speed-run for training. 
...
Below, is the *reduced* README from *modded-nanogpt*.
----
...
The Muon has the following favorable properties:
